...
public class loginSteps {
    ...
    public void userInputValidEmail() {
        loginpage.inputValidEmail("farhan@gmail.com");
    }

    @And("user input valid password")
    public void userInputValidPassword() {
        loginpage.inputValidPassword("farhan");
    }
    ...
    public void userInputInvalidEmail() {
        loginpage.inputInvalidEmail("farhan22@gmail.com");
    }
    ...
    public void userInputInvalidPassword() {
        loginpage.inputInvalidPassword("farhan22");
    }
